...
namespace CRM.API.Migrations
{
    ...
    [Migration("20260325124813_AddSubscriptionLifecycleFeatures")]
    partial class AddSubscriptionLifecycleFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.API.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("RenewedSubscriptionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RenewedSubscriptionId");
            ...
            modelBuilder.Entity("CRM.API.Models.ProductVariant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1899),
                            Description = "Comprehensive billing and invoicing solution",
                            DisplayOrder = 1,
                            Features = "[\"Feature1\", \"Feature2\"]",
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1900),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1904),
                            Description = "Lightweight solution",
                            DisplayOrder = 2,
                            Features = "[\"Feature1\", \"Feature2\"]",
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1904),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1908),
                            Description = "Full accounting suite",
                            DisplayOrder = 3,
                            Features = "[\"Feature1\", \"Feature2\"]",
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1908),
            ...
            modelBuilder.Entity("CRM.API.Models.SubscriptionHistory", b =>
                {
                    b.Property<int>("HistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRM.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1733),
                            Email = "admin@crm.com",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "System Admin",
                            ...
                            UpdatedAt = new DateTime(2026, 3, 25, 12, 48, 11, 978, DateTimeKind.Utc).AddTicks(1735)
                        });
                });
            ...
            modelBuilder.Entity("CRM.API.Models.Lead", b =>
                {
                    ...
                    b.HasOne("CRM.API.Models.User", "ConvertedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.API.Models.Order", b =>
                {
                    ...
                    b.HasOne("CRM.API.Models.Subscription", "RenewedSubscription")
                        .WithMany()
                        .HasForeignKey("RenewedSubscriptionId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("RenewedSubscription");
                });
            ...
            modelBuilder.Entity("CRM.API.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("CRM.API.Models.User", "SuspendedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.API.Models.SubscriptionHistory", b =>
                {
                    ...
                    b.HasOne("CRM.API.Models.Order", "RelatedOrder")
                        .WithMany()
