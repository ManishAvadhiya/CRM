...
function createSlot4(ownerName) {
  ...
  const Slot22 = React18.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React18.isValidElement(newElement) ? React18.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React18.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React25.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React29.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime20.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React29.isValidElement(newElement) ? React29.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime23.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React33.isValidElement(newElement) ? React33.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React33.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React37.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime26.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React37.isValidElement(newElement) ? React37.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable8(child) {
  return React37.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React40.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime29.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React40.isValidElement(newElement) ? React40.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React40.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var RemoveScroll = React47.forwardRef(function(props, parentRef) {
  ...
  return React47.createElement(
    React47.Fragment,
    null,
    enabled && React47.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
    forwardProps ? React47.cloneElement(React47.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React47.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React52.useRef(false);
  ...
  return (0, import_jsx_runtime32.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime32.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime32.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React52.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React52.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React52.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime32.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React52.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React52.useState(null);
    const contentRef = React52.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React52.useRef(0);
    const searchRef = React52.useRef("");
    const pointerGraceTimerRef = React52.useRef(0);
    const pointerGraceIntentRef = React52.useRef(null);
    const pointerDirRef = React52.useRef("right");
    const lastPointerXRef = React52.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React52.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React52.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime32.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React52.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React52.useCallback(
          (event) => {
            var _a;
        ...
        onPointerGraceIntentChange: React52.useCallback((intent) => {
...
var MenuGroup = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React52.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React52.useState("");
    React52.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React52.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React52.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React52.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React52.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React52.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React52.useEffect(() => {
...
var MenuSubContent = React52.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
var DropdownMenuTrigger = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React53.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React53.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React53.forwardRef((props, forwardedRef) => {
